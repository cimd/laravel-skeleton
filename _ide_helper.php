...
namespace Illuminate\Support\Facades {
     ...
     */        class Response {
         ...
         * Response Macros
         *
         * @see \Konnec\VueEloquentApi\Providers\ServiceProvider::boot()
         * @param mixed $data
         * @param mixed $status
         * @static 
         */        public static function index($data, $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::index($data, $status);
        }
                    /**
         * 
         *
         ...
         * @param mixed $status
         * @static 
         */        public static function show($data, $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::show($data, $status);
        }
                    /**
         * 
         *
         ...
         * @param mixed $status
         * @static 
         */        public static function store($data, $status = 201)
        {
                        return \Illuminate\Routing\ResponseFactory::store($data, $status);
        }
                    /**
         * 
         *
         ...
         * @param mixed $status
         * @static 
         */        public static function update($data, $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::update($data, $status);
        }
                    /**
         * 
         *
         ...
         * @param mixed $status
         * @static 
         */        public static function destroy($data, $status = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::destroy($data, $status);
        }
            }
            /**
     * 
     ...
     */        class Route {
         ...
         * Route Macros
         *
         * @see \Konnec\VueEloquentApi\Providers\RouteServiceProvider::boot()
         * @param mixed $uri
         * @param mixed $controller
         * @static 
         */        public static function batch($uri, $controller)
        {
                        return \Illuminate\Routing\Router::batch($uri, $controller);
        }
            }
            /**
     * 
